...
const ChildComment_1 = __importDefault(require("./comment/ChildComment"));
const ParantComment_1 = __importDefault(require("./comment/ParantComment"));
const commentRouter = express_1.default.Router();
commentRouter.use(`/parant`, ParantComment_1.default);
commentRouter.use(`/child`, ChildComment_1.default);
